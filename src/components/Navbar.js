  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 bg-white dark:bg-gray-900 border-t border-gray-200 dark:border-gray-700 shadow-md z-50">
      <ul className="flex justify-around items-center p-4 space-x-4">
        {/* Home */}
        <li className="flex flex-col items-center text-sm text-gray-700 dark:text-gray-200 hover:text-black dark:hover:text-white">
        ...
        {/* Add */}
        <li className="flex flex-col items-center bg-black text-white p-3 rounded-md text-sm hover:bg-gray-800 dark:hover:bg-gray-300 dark:bg-white dark:text-black">
